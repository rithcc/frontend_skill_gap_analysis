...
<body>
  ...
  // Removed manual startGeneration function
    ...
    <div>
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mb-8 flex flex-col items-center justify-center">
          <h1 className="text-2xl font-bold text-black text-center mb-2">AI-Powered Report Generation</h1>
          <p className="text-sm text-gray-700 text-center max-w-2xl mb-2">Transform your skill analysis into a comprehensive, stakeholder-ready report with interactive visualizations and actionable insights</p>
        </div>
      </div>
      ...
      {/* Removed manual start button. Generation starts automatically on page load. */}
